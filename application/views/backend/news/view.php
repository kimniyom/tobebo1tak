...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#file_upload').uploadify({
            ...
            'uploader': '<?= site_url('backend/news/upload_images_news/' . $news->id) ?>', //เมื่อ submit แล้วให้ action ไปที่ไฟล์ไหน
    ...
    function delete_news(news_id) {
        ...
        if (r == true) {
            ...
            $.post(url, data, function (success) {
                window.location = "<?php echo site_url('backend/news/get_news/' . $groupnews->id) ?>";
            });
        }
    }
...
<div class="well">
    <div class="pull-right">
        <a href="<?php echo site_url('backend/news/update/' . $news->id) ?>">
    ...
    <h3 style=" margin-top: 0px;"><?php echo $news->titel; ?></h3>
    <hr/>
    <div class="img-new">
        <?php if ($firstIMG) { ?>
