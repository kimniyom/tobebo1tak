                            ...
                            foreach ($modules->result() as $md) {
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" id="Smenu">
                                    <a href="<?php echo site_url($md->module) ?>" style=" text-decoration: none;" data-toggle="tooltip" data-placement="top" title="<?php echo $md->thainame ?>">
                                        <div id="submenu" class="btn btn-info btn-block hvr-trim" style="border-radius:0px; background: #FFFFFF; border: #999999; color: #999999;">
                                            <div class="text-menu"> 
                                                <img src="<?php echo base_url() ?>assets/module/<?php echo $md->module ?>/images/icon.png" style="height:32px;"/>
