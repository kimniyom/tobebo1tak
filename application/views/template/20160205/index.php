    ...
    <body id="body">
        <div class="container" id="main-content">
            <div class="btn btn-default pull-right" id="sign-in">
                <a href="<?php echo site_url('users/login') ?>"><i class="fa fa-lock"></i> เข้าสู่ระบบ</a>
            </div>
            <div id="head-logo">
            ...
            <div class="row" style=" margin: 0px;">
                    ...
                    <div class="well BL" id="bg_gray" style=" background: none;">
                        ...
                        <div class="list-group">
                            ...
                            foreach ($modules->result() as $md) {
                                ?>
                                <a href="<?php echo site_url($md->module) ?>" style=" text-decoration: none;border-radius: 0px;" class="list-group-item">
                                    <div id="submenu" style="border-radius:0px;">
                                        <div class="text-menu">
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 BR" id="side-right">
                    ...
                    -->
                    <div id="tooplate_content" style="word-wrap: break-word;">
                        <?php
                        if ($detail == "") {
