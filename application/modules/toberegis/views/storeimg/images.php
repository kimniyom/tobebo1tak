    ...
    foreach ($images->result() as $rs):
        ...
        <div class='col-md-3 col-lg-3'>
            <div class="thumbnail">
                ...
                <button type="button" class="btn btn-default btn-sm" onclick="Addcontent('<?php echo $row->ref ?>','<?php echo $rs->images ?>','<?php echo $rs->images_name ?>','0')"><i class="fa fa-check"></i> เลือก</button> | 
...
<script type="text/javascript">
    ...
    function saveeditimage() {
        var url = "<?php echo site_url('toberegis/storeimg/editimagename') ?>";
        var id = $("#_idimg").val();
    ...
    function deleteimages(id) {
        var url = "<?php echo site_url('toberegis/storeimg/deleteimages') ?>";
        var data = {id: id};
        $.post(url, data, function (datas) {
            getfolder("<?php echo $folder_id ?>");
        });
