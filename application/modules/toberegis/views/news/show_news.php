...
<div style=" clear: both;">
    <h3><i class="fa fa-newspaper-o"></i> ข่าวประชาสัมพันธ์</h3>
    <hr/>
</div>
<div class="row">
    ...
    <div class="col-md-9 col-lg-9">
        <a href="<?php echo site_url('toberegis/news/create') ?>">
            <button type="button" class="btn btn-success pull-right">
                <span class=" glyphicon glyphicon-plus"></span> สร้างข่าวประชาสัมพันธ์
            </button></a>
        ...
        <table width="100%" id="tb_mas_menu" class="table">
            ...
            <tbody>
                ...
                foreach ($news->result() as $rs):
                    ...
                    $rsfirst = $this->db->get_where('tobeimages_news', array("new_id" => $rs->id), "1")->row();
                        ...
                        <td align="left">
                            <div class="row">
                                ...
                                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-10">
                                    <a href="<?php echo site_url('toberegis/news/view/' . $this->takmoph_libraries->url_encode($rs->id)) ?>"><h4 style=" margin-top: 0px;"><?= $rs->title ?></h4></a>
