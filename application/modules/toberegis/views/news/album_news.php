<script type="text/javascript">
    function delete_img_album(id,images) {
        var url = "<?php echo site_url('toberegis/news/delete_images_news') ?>";
        ...
        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
            <div class="container-card" style="max-height:250px;">
                <div class="img-wrapper">
                    <img src="<?php echo base_url() ?>upload_images/news/thumb/<?php echo $rs->images; ?>" class="img-responsive img-polaroid" style="height:250px;"/>
                </div>
