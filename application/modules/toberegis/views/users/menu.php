...
<div class="list-group">
    ...
    <?php if ($privilege->news == 1) { ?>
        <a href="<?php echo site_url('toberegis/news/index') ?>" class="list-group-item"><i class='fa fa-file-o'></i> ข่าวประชาสัมพันธ์</a>
    <?php } else { ?>
        <div class="list-group-item disabled"><i class='fa fa-file'></i> ข่าวประชาสัมพันธ์</div>
    <?php } ?>
    <?php if ($privilege->activity == 1) { ?>
        <a href="<?php echo site_url('toberegis/activity/index') ?>" class="list-group-item"><i class='fa fa-photo'></i> รูปภาพกิจกรรม</a>
    <?php } else { ?>
