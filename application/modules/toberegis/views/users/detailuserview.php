    ...
    <div class="col-md-9 col-lg-9">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <h4><input type="checkbox" disabled="disabled" id="privatedata" <?php echo ($privatedata == 1) ? "checked" : "" ?>/> ดูข้อมูลส่วนตัวสมาชิก สูบบุหรี่,ดื่มสุรา,เหตุผลที่เข้าเป็นสมาชิก</h4>
            </div>
        </div>
    </div>
</div>
