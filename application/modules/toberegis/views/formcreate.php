...
<hr id="hr"/>
<h4 style="text-align: center;">สมัคสมาชิกชมรม TO BE NUMBER ONE</h4>
<div class="row">
		...
		<div class="col-md-10 col-lg-10">
			<div class="row">
				<div class="col-md-12 col-lg-6">
					<input type="text" class="form-control" name="address" id="address" placeholder="เลขที่ ... ซอย ...ถนน.." />
				</div>
			</div>
			<div class="row">
				<div class="col-md-3 col-lg-3">
					...
					<select id="changwat" class="form-control" onchange="getampur(this.value)">
						...
						<?php foreach($changwat->result() as $changwars): ?>
							<option value="<?php echo $changwars->changwatcode ?>" <?php echo ($changwars->changwatcode == '63') ? "selected" : "";?>><?php echo $changwars->changwatname; ?></option>
						<?php endforeach; ?>
					</select>
				</div>
				<div class="col-md-3 col-lg-3">
		...
		<div class="col-md-3 col-lg-3">
			<select id="occupation" class="form-control" onchange="getfilter(this.value,1)">
				...
				<?php foreach($occupation->result() as $occ): ?>
					<option value="<?php echo $occ->id ?>"><?php echo ($occ->code) ? $occ->code." ".$occ->name : $occ->name; ?></option>
				<?php endforeach; ?>
			</select>
		</div>
			<div class="col-md-3 col-lg-3">
			...
			<div class="col-md-3 col-lg-3">
			<div id="boxlv3"></div>
			<input type="text" name="classroom" id="classroom" class='form-control' placeholder="กำลังศึกษาอยู่ชั้น..." style="display: none;" />
		</div>
	</div>
	<div class="row">
		...
		<div class="col-md-10 col-lg-10">
			<div class="row">
				...
				<div class="col-md-12 col-lg-12">
					<input type="radio" name="education" id="education" value="<?php echo $edu->id ?>" /> 
	...
	<div class="row">
		...
		<div class="col-md-10 col-lg-10">
			<div class="row">
				...
				<div class="col-md-12 col-lg-12">
					<input type="radio" name="alcohol" id="alcohol" value="<?php echo $lgh->id ?>" /> 
	...
	<div class="row">
		...
		<div class="col-md-10 col-lg-10">
			<div class="row">
				...
				<div class="col-md-12 col-lg-12">
					<input type="radio" name="smoking" id="smoking" value="<?php echo $sk->id ?>" /> 
					<?php echo $sk->smoking ?>
				</div>
			<?php endforeach; ?>
			</div>
...
<script type="text/javascript">
	...
	function disabledform(){
		...
		$("#changwat").css({'background':'#eeeeee'});
		$("#ampur").attr('disabled',true);
		$("#ampur").css({'background':'#eeeeee'});
		$("#tambon").attr('disabled',true);
		$("#tambon").css({'background':'#eeeeee'});
		$("#village").attr('disabled',true);
		$("#village").css({'background':'#eeeeee'});
		$("#occupation").attr('disabled',true);
		$("#occupation").css({'background':'#eeeeee'});
	}
