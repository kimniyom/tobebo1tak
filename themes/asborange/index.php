...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap 3-->
        <link href="<?php echo base_url() ?><?php echo $path ?>/css/bootstrap-cosmo.css" rel="stylesheet" type="text/css" />
    ...
    <body id="body">
        <div id="main-content">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="nav-bar"
                 style=" background: <?php echo $style->color_navbar ?>;box-shadow:#000000 0px 0px 10px 0px;">
                                ...
                                foreach ($homenews->result() as $new):
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                        <div class="container-card" style="max-height: 200px;border:<?php echo $style->color_navbar ?> solid 1px;">
                                            ...
                                            <a href="<?php echo site_url('news/view/' . $this->takmoph_libraries->encode($new->id).'/'.$this->takmoph_libraries->encode($new->groupnews)) ?>">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-<?php echo $Gn->column ?>">
                                                ...
                                                if ($Gn->column == '12') {
                                                    ...
                                                    <div class="container-card" style="max-height: 200px;border-color:<?php echo $headcolor ?>">
                                                        ...
                                                        <a href="<?php echo site_url('news/view/' . $this->takmoph_libraries->encode($news->id) . '/' . $this->takmoph_libraries->encode($news->groupnews)) ?>">
                                                            <button type="button" class="btn btn-danger btn-xs" id="btn-card"> อ่านข่าว ...</button>
                                                        </a>
                                                    </div>
                                                <?php } ?>
...
####################
        ...
        ########################
        -->
        <nav class="navbar navbar-inverse" role="navigation" style="background: <?php echo $style->color_navbar; ?>;border:none;" id="footer">
            <div class="container">
