                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        foreach ($subnav->result() as $snSub):
                                            ?>
                                            <li>
                                                <a href="<?php echo site_url('site/page/' . $this->takmoph_libraries->encode($snSub->id)) ?>" id="font-16">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="container-card link-hot" style=" max-height: 170px; border: none;">
                                            ...
                                            <p class="detail" style="padding: 10px;">
                                                <a href="<?php echo site_url('news/view/' . $this->takmoph_libraries->encode($hotNews->id) . '/' . $this->takmoph_libraries->encode($hotNews->groupnews)) ?>">
